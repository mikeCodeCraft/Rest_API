...
ALLOWED_HOSTS = [host.strip() for host in os.environ.get("ALLOWED_HOSTS").split(",")] # I will comeback to this later
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware', # I will come back to this later
