"""
Django settings for taskly_app project.
...
SECRET_KEY = 'django-insecure-_8^qtve%(2sjc*lt5=4^qq@%n^f+r8*j-8u^_o8tv%!xov8(0^'
...
WSGI_APPLICATION = 'taskly_app.wsgi.application'
...
DATABASES['default'] = dj_database_url.parse("postgresql://restapi_3jlw_user:FdDyerf8NZC33QQoOHs6yy5WpzVroA3k@dpg-d0t32pmmcj7s73b5acig-a.oregon-postgres.render.com/restapi_3jlw")
